...
+ (NSURL *)urlBundlePath:(NSString *)fileName {
	return [NSURL URLWithString:[NSString stringWithFormat:@"file://%@", [GRUtilities bundlePath:fileName]]];
}

+ (NSURL *)urlDocumentsPath:(NSString *)fileName {
    return [NSURL URLWithString:[NSString stringWithFormat:@"file://%@", [GRUtilities documentsPath:fileName]]];
}
