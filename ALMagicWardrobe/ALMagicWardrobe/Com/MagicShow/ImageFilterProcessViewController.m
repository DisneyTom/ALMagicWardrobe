...
- (void)viewDidLoad
{
    ...
    rootImageView = [[ALImageView alloc ] initWithFrame:CGRectMake(40, 70, 230, 300)];
    ...
    for(int i=0;i<14;i++)
    {
        ...
        ALImageView *bgImageView = [[ALImageView alloc]initWithFrame:CGRectMake(x, 10, 40, 43)];
...
-(UIImage *)changeImage:(int)index imageView:(ALImageView *)imageView
{
    UIImage *image;
    switch (index) {
        case 0:
