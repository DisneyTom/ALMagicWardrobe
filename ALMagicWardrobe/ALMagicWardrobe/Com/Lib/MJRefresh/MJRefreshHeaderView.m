...
@property (nonatomic, weak) ALLabel *lastUpdateTimeLabel;
@end
 ...
 *  时间标签
 */
- (ALLabel *)lastUpdateTimeLabel
{
    if (!_lastUpdateTimeLabel) {
        // 1.创建控件
        ALLabel *lastUpdateTimeLabel = [[ALLabel alloc] initWithFrame:CGRectZero BoldFont:12 BGColor:RGB_BG_Clear FontColor:MJRefreshLabelTextColor];
...
//        lastUpdateTimeLabel.textAlignment = NSTextAlignmentCenter;
        lastUpdateTimeLabel.verticalAlignment = VerticalAlignmentTop;
