...
- (void) drawRect:(CGRect)rect
{
    ...
    for (int i = 0; i < _itemNameArray.count; i++) {
        ...
        CGSize stringSize = [string sizeWithFont:[UIFont systemFontOfSize:13]];
        ...
        if (self.selectIndex == i && !_disableSelectState) {
            ...
            [string drawInRect:stringRect withFont:[UIFont systemFontOfSize:13]];
        } else {
            [HEX(@"#c41517") setFill];
            [HEX(@"#c41517") setStroke];
            [string drawInRect:stringRect withFont:[UIFont systemFontOfSize:13]];
        }
        ...
        if ((i > 0 && i - 1 != self.selectIndex && i != self.selectIndex) || _momentary) {
            ...
            CGContextSetStrokeColorWithColor(c, HEX(@"#c41517").CGColor);
