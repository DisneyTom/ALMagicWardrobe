...
-(void) setupViews
{
    ...
    CGFloat startY = 10;
    CGRect  frame = CGRectMake(0, startY, kScreenWidth, 180);
    [self setupShowHeadViewWithFrame:frame];
    
    startY += 182;
    frame = CGRectMake(0, startY, kScreenWidth, AL_VIEW_DEFAULT_IMAGE_HEIGHT+80);
...
#pragma mark -
-(void) setupShowHeadViewWithFrame:(CGRect)frame
{
